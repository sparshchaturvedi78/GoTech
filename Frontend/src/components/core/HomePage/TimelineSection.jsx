...
const TimelineSection = () => {
    return (
        <div>
            <div className="flex flex-col lg:flex-row gap-20 mb-20 items-center mt-10">
                            ...
                            <div className="flex flex-col" key={i}>
                                <div className="flex gap-6" key={i}>
                                    <div className="w-[52px] h-[52px] bg-white rounded-full flex justify-center items-center shadow-[#00000012] shadow-[0_0_62px_0]">
                                        <img className='object-contain w-full h-full p-2' src={ele.Logo} alt="" />
                                    </div>
                                    <div>
                ...
                <div className='relative w-[100%] h-fit shadow-blue-25 shadow-[0px_0px_60px_0px]'>
